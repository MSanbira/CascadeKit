...
export function ThemePage() {
  ...
  return (
    <div className="ThemePage--root Section--sections-wrapper">
      ...
      <Section>
        <Text variant="h2" bottomMargin id="howThemesWork">How themes work</Text>
        <Text>
        ...
        <Box className="d-grid" mixin={{ gap: 4, mt: 4, smallScreen: { gridColTemplate: '1fr' }, mediumScreen: { gridColTemplate: '1fr 1fr 1fr' } }}>
          <Card className="ThemePage--principle-card">
            <Text variant="h6" bottomMargin>1. Token Override</Text>
            <Text variant="body2">
          ...
          <Card className="ThemePage--principle-card">
            <Text variant="h6" bottomMargin>2. Layer Priority</Text>
            <Text variant="body2">
          ...
          <Card className="ThemePage--principle-card">
            <Text variant="h6" bottomMargin>3. Dark Mode Support</Text>
            <Text variant="body2">
      ...
      <Section>
        <Text variant="h2" bottomMargin id="definingATheme">Defining a theme</Text>
        <Text>
      ...
      <Section>
        <Text variant="h2" bottomMargin id="componentOverrides">Component overrides</Text>
        <Text>
      ...
      <Section>
        <Text variant="h2" bottomMargin id="themeContext">Theme context</Text>
        <Text>
      ...
      <Section>
        <Text variant="h2" bottomMargin id="livePreview">Live preview</Text>
        <Text>
      ...
      <Section>
        <Text variant="h2" bottomMargin id="creatingANewTheme">Creating a new theme</Text>
        <Box className="d-flex dir-col gap-3" mixin={{ mt: 3 }}>
          <Card>
            <Text variant="h6" bottomMargin>1. Add theme CSS</Text>
            <Text variant="body2">
          ...
          <Card>
            <Text variant="h6" bottomMargin>2. Register in context</Text>
            <Text variant="body2">
          ...
          <Card>
            <Text variant="h6" bottomMargin>3. Optional: Component overrides</Text>
            <Text variant="body2">
